...
import "github.com/JamesPeck/pic-sure-cli/internal/scripts"
...
var scriptCommandTable = []ScriptCommand{
	...
	},
	{
		...
		FlagsHelp: "--json (machine-readable; see pic-sure-all-in-one/docs/cli-contract.md)  --deep-health (probe the gateway's /system/status)",
	},
	{
		Name:      "preflight",
