...
// truth for all state mutations — see pic-sure-all-in-one/docs/cli-contract.md).
package commands
...
import (
	...
	"github.com/JamesPeck/pic-sure-cli/internal/exec"
	"github.com/JamesPeck/pic-sure-cli/internal/project"
